...
Discuss with Daniel:
- combine the dimensions: edges&glides
0 make random number for AREA & distance from road??
...
```{r diversity, echo=FALSE, fig.dim = c(7, 3), include=T}
...
why is CCF having more species than other regimes?

```{r plot-diversity, echo=FALSE, fig.dim = c(7, 3), include=T}
...
```{r plot-richness, echo = F, include=T, fig.dim = c(7, 3)}
